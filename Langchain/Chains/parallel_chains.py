...
prompt1 = PromptTemplate(
    template="Provide a short and simple note from the following : {topic}.",
    input_variables=["topic"],  
)

prompt2 = PromptTemplate(
    template="Make a 5 question quiz of the following : {topic}.",
    input_variables=["topic"],
)

prompt3 = PromptTemplate(
    template="Merge the following note and quiz into a single study guide:\n\nNote:\n{note}\n\nQuiz:\n{quiz}",
